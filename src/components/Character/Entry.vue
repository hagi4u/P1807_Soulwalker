    ...
    data(){
      return {
        ...
        entry: [{
          ...
          name: '하루 에스티아',
          video: 'neglpAdNeEg',
          text: '하루에스티아!! 스탠다드한 스타일.<br/>안정성이 뛰어나고 대검 한 방 한 방이 묵직하지!'
        },{
          key: 2,
          m_key: 32,
          name: '어원 아크라이트',
          ...
          name: '릴리 블룸메르헨',
          video: 'zmP89uRP6DQ',
          text: '릴리 블룸메르헨!! 소름끼치는 광기와 잔혹함을<br/>숨기고 있는 그녀. 위력적인 광역 공격이 일품이지!'
        },{
          key: 4,
          m_key: 34,
          name: '스텔라 유니벨',
          ...
          name: '이리스 유마',
          video: 'ZYLfYqbM5ZI',
          text: '이리스 유마!! 마지막 승급 업데이트의 주인공.<br/>거포에서 뿜어져 나오는 압도적 화력, 이번 승급으로<br/>더 핫 해진 친구지!'
        },{
          key: 6,
          m_key: 36,
          name: '진 세이파츠',
